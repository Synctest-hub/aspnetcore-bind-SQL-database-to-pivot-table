...
A quick start project for connecting a SQL Database to a Syncfusion Pivot Table. This repository includes a core Web API Controller (PivotController) for retrieving data from a SQL Database, as well as a quick start sample for the ASP.NET Core platform that displays the retrieved data in a Pivot Table.
